...
public class DeveloperPageController {
		...
		public String submitEdittedQuestionDetail(@ModelAttribute
			...
			return "redirect:/developer/questions/detail/"+questionId;
		...
		public String loadDeveloperCommunityLibraryDetailPage(@PathVariable("bestPracticeId") long bestPracticeId,HttpServletRequest request,Model model){
		...
		public String submitEdittedLibraryDetail(@ModelAttribute
			...
			return "redirect:/developer/library/detail/"+bestPracticeId ;
		...
		public String submitEdittedScenarioDetail(@ModelAttribute
			...
			question.setQuestionString(form.getQuestionString());
			question.setDetailedDescription(form.getDetailedDescription());
			return "redirect:/developer/scenarios/detail/"+questionId;
		...
		private void setCommonAttributes(Model model,String page) {
			...
			model.addAttribute("community","developer");
		...
		private void setQuestionList() {
			...
			question1.setCommunity("developer");
			...
			question2.setCommunity("developer");
			...
			question3.setCommunity("developer");
			...
			question4.setCommunity("developer");
			...
			question5.setCommunity("developer");
			...
			question6.setCommunity("developer");
			...
			question7.setCommunity("developer");
			...
			question8.setCommunity("developer");
			...
			question9.setCommunity("developer");
			...
			question10.setCommunity("developer");
			...
			question11.setCommunity("developer");
			...
			question12.setCommunity("developer");
			...
			+"\n\nFor more details, refer: https://methodology.accenture.com/dist_agile/#meth.dist_agile/guidances/guidelines/Developer%20Release%20Planning%20Guidelines_E73369A2.html ");
			question12.setAnswerList(new ArrayList<Answer>());
			
			Question question13 = new Question ();
			question13.setQuestionId(13L);
			question13.setCommunity("developer");
			...
			question14.setCommunity("developer");
			...
			question15.setCommunity("developer");
			...
			question16.setCommunity("developer");
			...
			question17.setCommunity("developer");
			...
			question18.setCommunity("developer");	
			...
			question19.setCommunity("developer");
			...
			question19.setRecommendedSolution("Continuous Integration:"
					...
					+"\n\nFor more details, refer: https://methodology.accenture.com/dist_agile/#meth.dist_agile/guidances/guidelines/Developer%20Continuous%20Integration%20Environment%20Guidelines_6CAE42E1.html");
			question19.setAnswerList(new ArrayList<Answer>());

			Question question20 = new Question ();
			question20.setQuestionId(20L);
			question20.setCommunity("developer");
			...
			question20.setRecommendedSolution("Kanban Wall:"
					...
					+"\nhttps://methodology.accenture.com/dist_agile/#meth.dist_agile/guidances/guidelines/Developer%20Kanban%20Board%20Setup%20and%20Management%20Guidelines_D4026BC7.html ");
			question20.setAnswerList(new ArrayList<Answer>());
			
			Question question21 = new Question ();
			question21.setQuestionId(21L);
			question21.setCommunity("developer");
			...
			question22.setCommunity("developer");
			...
			question23.setCommunity("developer");
			...
			question24.setCommunity("developer");
			...
			question25.setCommunity("developer");
			...
			question26.setCommunity("developer");
