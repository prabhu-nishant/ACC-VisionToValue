...
public class BAPageController {
	...
	public String loadBACommunityLibraryDetailPage(@PathVariable("questionId") long questionId,HttpServletRequest request,Model model){
	...
	public String submitEdittedLibraryDetail(@ModelAttribute
		...
		return "redirect:/ba/library/detail/"+questionId;
	}
