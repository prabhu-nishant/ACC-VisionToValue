...
public class BAPageController {
		...
		public String submitEdittedQuestionDetail(@ModelAttribute
			...
			return "redirect:/ba/questions/detail/"+questionId;
		...
		public String submitEdittedLibraryDetail(@ModelAttribute
			...
			return "redirect:/ba/library/detail/"+bestPracticeId ;
		...
		public String submitEdittedScenarioDetail(@ModelAttribute
			...
			question.setQuestionString(form.getQuestionString());
			question.setDetailedDescription(form.getDetailedDescription());
			return "redirect:/ba/scenarios/detail/"+questionId;
		...
		private void setQuestionList() {
			...
			question8.setRecommendedSolution("Kano Analysis:"
					...
					+"\nQFD is a strcutured  method in which customer requirements are translated into appropriate technical requirements for each stage of application or product development. In simple words, QFD is the voice of the customer translated into voice of the ba");
			
			question8.setAnswerList(new ArrayList<Answer>());
			
			Question question9 = new Question ();
			question9.setQuestionId(9L);
			question9.setCommunity("ba");
			...
			question11.setRecommendedSolution("Test Driven Development (TDD):"
					...
					+"\n\nHow-To:"
					+"\n1. The ba writes an (initially failing) automated test case that defines a desired improvement or new function."
					+"\n2. The ba produces the minimum amount of code to pass that test."
			...
			question21.setRecommendedSolution("Automated Deploy:"
					+"\nThis practice can be achieved by the using a Continuous Integration framework, which will perform the automated deployment at regular and pre-determined intervals or can be triggered by code check in by a ba ");
			question21.setAnswerList(new ArrayList<Answer>());
			
			Question question22 = new Question ();
			question22.setQuestionId(22L);
			question22.setCommunity("ba");
